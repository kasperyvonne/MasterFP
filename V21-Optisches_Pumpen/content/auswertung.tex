...
\begin{align*}
  ...
  J&=\frac{1}{2}
\end{align*}
Für die Berechnung der Kernspins wird die Formel \eqref{eq:gf} nach $I$ umgestellt.
Desweiternen ergibt sich aus den Werten für $L,S$und $J$ $g_J = 2.0023$. Die Formel \eqref{eq:gJ} lässt sich nach $I$ umstellen:
\begin{equation}
...
$\symup{^{85}Rb}$ und $\Delta E_{hy} = 2.01\cdot 10^{-24}\si{\joule}$ für $\symup{^{87}Rb}$.
