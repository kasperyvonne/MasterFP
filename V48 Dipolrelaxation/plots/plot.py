...
#plt.plot(temp1, fc1, 'xb', label = "Messdaten Heizrate = 2")
#plt.plot(ut1, uc1, 'or', label='Untergrund-Daten')
#plt.plot(xf1, fit(xf1,*noms(params1)), '--g', label='Untergrundausgleich')
#plt.vlines([-36.6,2.4],-11,45,colors='r',linestyle='--',label='Auswertungsbreich')
...
#plt.plot(temp2, fc2, 'xb', label = "Messdaten Heizrate = 1.5")
#plt.plot(ut2, uc2, 'or', label='Untergrund-Daten')
#plt.plot(xf1, fit(xf1,*noms(params2)), '--g', label='Untergrundausgleich')
#plt.vlines([-41.8,-0.4],-11,45,colors='r',linestyle='--',label='Auswertungsbreich')
...
#plt.plot(xt,lnWfit(xt,*noms(params2lnW2)),'--k', label='Ausgleichsgerade Heizrate = 1.5')
#plt.grid()
###plt.ylim(-10,30)
