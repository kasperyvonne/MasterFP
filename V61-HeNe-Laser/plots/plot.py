...
#plt.subplot(1, 2, 1)
plt.plot(L1, stabiparams(L1,roc,rk1), label=r'$r_1 = 1400$ \& $r_2= 1000$')
plt.xlabel(r'Resonatorabstand $L/mm$')
plt.ylabel(r'Stabilitätsparameter $g_1 \cdot g_2$')
plt.axhline(1, linestyle = '--',color='r', label='Laserbereich')
plt.axhline(0, linestyle = '--',color='r')
plt.axvline(240, linestyle = '--',color='g')
plt.axvline(0, linestyle = '--',color='g',label='1 bei 0 und 240')
plt.grid()
plt.legend(loc='best')
